                ...
                <tr>
                  ...
                  <td>
                    <?php if(!empty($item['image'])): ?>
                      <img src="uploads/<?= $item['image']; ?>" alt="<?= $item['name']; ?>" class="category-image">
                    <?php else: ?>
                      <div class="no-image">
                  ...
                  <td>
                    <a href="edit_category.php?id=<?= $item['id']; ?>" class="btn btn-primary btn-sm">
                      <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="delete_category.php?id=<?= $item['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this category?')">
