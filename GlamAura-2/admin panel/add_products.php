    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if(in_array($image_ext, $allowed_extensions)) {
            ...
            if(move_uploaded_file($image_tmp, $upload_dir . $filename)) {
                $prod_query = "INSERT INTO product (name, image, description, price, quantity, category_id) 
                              VALUES ('$name', '$filename', '$description', '$price', '$quantity', $category_id)";
...
<body>
    <div class="layout">
        ...
        <aside class="sidebar">
          ...
          <li class="active"><a href="add_products.php"><i class="fas fa-cart-plus"></i> <span>Add Products</span></a></li>
            ...
            <div class="card">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control mb-2" name="name" placeholder="Enter product name" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control mb-2" name="quantity" placeholder="Enter quantity" required></input>
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">Price</label>
                        <input class="form-control mb-2" name="price" placeholder="Enter price" required></input>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control mb-2" name="description" rows="4" placeholder="Enter description"
                            required></textarea>
                    </div>
